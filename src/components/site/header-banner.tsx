...
const slides: BannerSlide[] = [
  {
    ...
    badge: "ফলের বাগান",
    title: "টক-মিষ্টি আমে ভরা",
    highlight: "আপনার ছাদ",
    description:
      "ছাদের বাগানে আম চাষ করে দেখুন প্রচুর ফলন। আমাদের জৈব সার ও বীজ দিয়ে গড়ে তুলুন আপনার ফলের বাগান।",
    cta: "ফলের বীজ দেখুন",
    href: "/category/3",
  },
  {
    ...
    highlight: "আপনার ছাদ",
    description:
      "শহরের কংক্রিটের জগতে ছাদ বাগান তৈরি করে প্রকৃতির সংস্পর্শে আসুন। সার, বীজ, টব — সবকিছু এক ছাদে।",
    cta: "বাগান শুরু করুন",
