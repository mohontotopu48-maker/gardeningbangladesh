...
export function MegaMenu() {
  ...
  return (
    ...
    >
      <button className="group flex h-full items-center gap-1.5 px-4 text-sm font-bold text-white bg-brand-black hover:bg-brand-black-light rounded-lg mx-1 my-0.5 transition-all hover:shadow-md hover:scale-105 whitespace-nowrap">
